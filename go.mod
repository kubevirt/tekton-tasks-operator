module github.com/kubevirt/tekton-tasks-operator
...
replace k8s.io/cluster-bootstrap => k8s.io/cluster-bootstrap v0.22.6

replace github.com/kubevirt/tekton-tasks-operator/api => ./api
