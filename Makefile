...
bundle: operator-sdk manifests kustomize csv-generator
	...
	./bin/csv-generator --csv-version $(VERSION) --operator-image $(IMG) --operator-version $(VERSION) --namespace kubevirt \
			--file bundle/manifests/tekton-tasks-operator.clusterserviceversion.yaml > bundle/manifests/tekton-tasks-operator.clusterserviceversion.yaml.new
	mv bundle/manifests/tekton-tasks-operator.clusterserviceversion.yaml.new bundle/manifests/tekton-tasks-operator.clusterserviceversion.yaml
